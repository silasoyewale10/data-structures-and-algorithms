...
const evenOdd = (arr) => {
    ...
    arr.map (item => {
        ...
        if(item % 2 === 0){
            ar.push('even')
            // console.log(item + " divided by 2 is even")
        } else if (item % 2 > 0){
            ar.push ('odd')
...
const extractStats = (arr) => {
    ...
    return arr.map(item => {
        return{
            name: item.stat.name,
            // console.log(arr[0].stat.name)  //name
            // console.log(arr[0].effort)
            // console.log(arr[0].baseStat)
            // console.log(Object.entries(arr[0])[0][1])
            // var obj = Object.entries(arr[0])[0][1]
            // console.log ("obj is " + Object.entries(obj) )
